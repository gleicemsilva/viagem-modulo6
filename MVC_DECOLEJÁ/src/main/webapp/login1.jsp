...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   ...
   <!-- ICON DECOLE JÁ -->
    <link rel="shortcut icon" href="img/icon_decole.png" type="image/x-icon">
    ...
    <title> Login - Decole Já | Agência de Viagens </title>
    ...
    <div class="container-fluid mt-3">
        ...
        <header class="row">
            ...
            <div class="col-sm-6 text-center">
                ...
                <h5> Quer viajar? </h5>
                <p class="small"> A Decole Já Viagens leva você aonde quiser! </p>
    ...
    <footer class="container-fluid bg-light">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6 text-justify">
                ...
                <p class="m-0 small">CNPJ 12.345.678/0001-23</p>
                <p class="m-0 small">Rua Marques da Silva, 0001 - HTML CSS BOOTSTRAP</p>
                <p class="m-0 small">CEP: 10101-010, Internet</p>
        ...
        <div class="row mt-4 mb-3">
            <div class="col-12 text-center"> &copy 2023 - Decole Já Agência de Viagens </div>
        </div>
